"""
 ...
 Ejemplo completo de extracción y clasificacion con Arbol de Decisión
...
model = tree.DecisionTreeClassifier(splitter = 'best', criterion = 'entropy', random_state=None)
